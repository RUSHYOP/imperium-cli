...
- Containers: `{ "lg": {} }` (or with `height`)
- Rows: `{ "lg": { "alignItems": "...", "justifyContent": "..." } }`
- Columns: `{ "lg": { "col": 12 }, "md": { "col": 12 }, "sm": { "col": 12 } }`
- Leaf components: `{ "lg": { "col": 12 }, "md": { "col": 12 }, "sm": { "col": 12 } }`
- Only `lg` is strictly required; `md`/`sm` are optional but recommended.
