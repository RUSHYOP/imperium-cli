...
program
  ...
  .addHelpText('after', () => [
    ...
    `  ${c.cmd('imperium setup claude --preset fullstack')}       Scaffold + apply a curated preset`,
...
// ---- setup ---------------------------------------------------------------
{
  ...
  cmd.addHelpText('after', () => [
    ...
    ex('$ imperium setup claude --preset fullstack', 'Setup + apply a curated preset'),
    ex('$ imperium setup --preset fullstack', 'Adapter inferred from preset'),
    ...
    ex('$ imperium setup claude --preset fullstack --with extra-skill', 'Preset + extra skills'),
